...
var chapterButtonsUrl = "";
    if (qType == 1) {
      ...
      //SelfHard
      chapterButtonsUrl = 'SelfHard';

    } else if (qType == 3) {
      //OthersHard
      chapterButtonsUrl = 'OthersHard';

    } else if (qType == 4) {
      //SelfMostTimeTaken
      chapterButtonsUrl = 'SelfMostTimeTaken';

    } else if (qType == 5) {
      //OthersMostTimeTaken
      chapterButtonsUrl = 'OthersMostTimeTaken';

    } else if (qType == 6) {
      //DontShowQuestions
      chapterButtonsUrl = 'DontShowQuestions';
